  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved manager as @manager" do
        ...
        post :create, {:manager => { "assigned_by" => "invalid value" }}, valid_session
        assigns(:manager).should be_a_new(Manager)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested manager" do
        ...
        Manager.any_instance.should_receive(:update_attributes).with({ "assigned_by" => "MyString" })
        put :update, {:id => manager.to_param, :manager => { "assigned_by" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the manager as @manager" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Manager.any_instance.stub(:save).and_return(false)
        put :update, {:id => manager.to_param, :manager => { "assigned_by" => "invalid value" }}, valid_session
        assigns(:manager).should eq(manager)
      end
