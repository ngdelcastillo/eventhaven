  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved member as @member" do
        ...
        post :create, {:member => { "assigned_by" => "invalid value" }}, valid_session
        assigns(:member).should be_a_new(Member)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested member" do
        ...
        Member.any_instance.should_receive(:update_attributes).with({ "assigned_by" => "MyString" })
        put :update, {:id => member.to_param, :member => { "assigned_by" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the member as @member" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Member.any_instance.stub(:save).and_return(false)
        put :update, {:id => member.to_param, :member => { "assigned_by" => "invalid value" }}, valid_session
        assigns(:member).should eq(member)
      end
