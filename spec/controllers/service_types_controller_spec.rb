  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved service_type as @service_type" do
        ...
        post :create, {:service_type => { "name" => "invalid value" }}, valid_session
        assigns(:service_type).should be_a_new(ServiceType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested service_type" do
        ...
        ServiceType.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => service_type.to_param, :service_type => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the service_type as @service_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ServiceType.any_instance.stub(:save).and_return(false)
        put :update, {:id => service_type.to_param, :service_type => { "name" => "invalid value" }}, valid_session
        assigns(:service_type).should eq(service_type)
      end
